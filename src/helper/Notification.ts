...
class Notifikasi {
    configure = () => {
        PushNotification.configure({
            ...
            // requestPermissions: Platform.OS === 'ios' // This line seems redundant
          });
    }
    ...
    sendNotification = (channel: string, title: string, message: string) => {
    ...
    sendNotificationSchedule = (channel: string, title: string, message: string) => {
